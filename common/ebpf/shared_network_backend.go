...
func prepareSharedNetworkRuntime(
	...
	runtimeState.maps, err = loadObjectMaps(loadSharedNetwork, map[string]mapSpecOverride{
		...
		"shared_host_ipv4":           {name: "sb_sh_host4", mapType: CiliumEBPF.LPMTrie, maxEntries: 256, flags: bpfFlagNoPrealloc},
		"shared_host_ipv6":           {name: "sb_sh_host6", mapType: CiliumEBPF.LPMTrie, maxEntries: 256, flags: bpfFlagNoPrealloc},
